...
import { UserCircle, Save, ArrowLeft, Mail, Phone, MapPin, Map } from 'lucide-react'
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          {t('profile.host.description') || 'Gestiona tu perfil de host'}
        </p>
      </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder={t('profile.bioPlaceholder') || 'Cuéntanos sobre tus experiencias y tours...'}
                  rows={4}
                />
              </div>

              <div>
                <Label htmlFor="specialties">{t('profile.specialties') || 'Especialidades'}</Label>
                <Textarea
                  id="specialties"
                  value={formData.specialties}
                  onChange={(e) => setFormData({ ...formData, specialties: e.target.value })}
                  placeholder={t('profile.specialtiesPlaceholder') || 'Tours off-road, experiencias de larga duración, etc.'}
                  rows={3}
                />
              </div>
            </CardContent>
