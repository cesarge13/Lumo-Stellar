...
import { UserCircle, Save, ArrowLeft, Mail, Phone, MapPin, ShieldCheck } from 'lucide-react'
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          {t('profile.moderator.description') || 'Gestiona tu perfil de moderador'}
        </p>
      </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder={t('profile.bioPlaceholder') || 'Información sobre tu rol como moderador...'}
                  rows={4}
                />
              </div>
            </CardContent>
